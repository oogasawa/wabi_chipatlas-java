...
public class ChipatlasErrorReport extends WabiErrorReport {

	public ChipatlasErrorReport(WabiRequest req) throws IOException {
		super(req);
	}
	
	public ChipatlasErrorReport(ChipatlasRequest req) throws IOException {
		super(req);
	}
