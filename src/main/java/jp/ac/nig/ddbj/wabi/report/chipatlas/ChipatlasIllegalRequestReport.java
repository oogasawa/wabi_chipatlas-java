...
public class ChipatlasIllegalRequestReport extends WabiIllegalRequestReport {
	public ChipatlasIllegalRequestReport(WabiRequest req) {
		super(req);
	}

	public ChipatlasIllegalRequestReport(ChipatlasRequest req) {
		super(req);
	}

	public ChipatlasIllegalRequestReport(WabiGetRequest request) {
		super(request);
	}
